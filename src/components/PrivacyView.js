  ...
  return `
    <div class="container section-padding" style="max-width: 860px;">
      <header class="text-center" style="margin-bottom: 3rem;">
        ...
        <h1 class="heading-xl" style="margin-bottom: 0.75rem;">Privacy Policy</h1>
      ...
      <div class="legal-page-body">
        ...
        <ul>
          ...
          <li><strong>Contact Information:</strong> Name and email address when submitting inquiries through our contact form.</li>
        </ul>

        <h2>2. How We Use Your Information</h2>
        <p>We use the collected information in various ways, including to:</p>
        <ul>
          <li>Provide, operate, and maintain our hair beauty magazine.</li>
          <li>Improve, personalize, and expand our listicle content and category navigation.</li>
          <li>Understand and analyze how visitors interact with our hairstyle guides.</li>
          <li>Develop new hair inspiration lookbooks, styling masterclasses, and feature guides.</li>
          <li>Send periodic newsletter updates if explicitly requested by you.</li>
        </ul>
